...
GX_TEXT_BUTTON_PROPERTIES ams_window_s7_properties =
{
...
GX_CONST GX_STUDIO_WIDGET ams_window_s7_define =
{
    "s7",
    GX_TYPE_TEXT_BUTTON,                     /* widget type                    */
    IDB_AMS_S7_BTN,                          /* widget id                      */
    #if defined(GX_WIDGET_USER_DATA)
    0,                                       /* user data                      */
    #endif
    ...
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(AMS_WINDOW_CONTROL_BLOCK, ams_window_s7), /* control block        */
    (void *) &ams_window_s7_properties       /* extended properties            */
};
...
GX_CONST GX_STUDIO_WIDGET ams_window_main_define =
{
    ...
    &ams_window_s7_define,                   /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
...
{
    GX_PIXELMAP_ID_ZEPHYR_LOGO_TEXT_COLOR_240X93, /* normal pixelmap id        */
...
GX_CONST GX_STUDIO_WIDGET main_window_S7_define =
{
    ...
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_WINDOW_CONTROL_BLOCK, main_window_S7), /* control block      */
...
GX_CONST GX_STUDIO_WIDGET main_window_pixelmap_button_1_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {0, 20, 239, 112},                       /* widget size                    */
    &main_window_title_define,               /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_WINDOW_CONTROL_BLOCK, main_window_pixelmap_button_1), /* control block */
